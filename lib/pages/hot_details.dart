...
class HotDetails extends StatelessWidget {
  HotDetails({Key? key}) : super(key: key);
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            ...
            //   showBadge: true,
            //   badgeContent: Text(controller.cart.length > 9 ? '9+'
        ...
        body: Obx(
          () => (_hotDetailsController.isLoading.value)
              ...
              : _hotDetailsController.gethotDetails!.hotDeals?.length == 0
                  ? Center(
                      child: Text("No Data"),
                    )
                  : ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        final item =
                            _hotDetailsController.gethotDetails?.hotDeals;
                        return Stack(
                          children: [
                            Container(
                                    ...
                                    SizedBox(
                                        ...
                                        child: ElevatedButton(
                                          style: ElevatedButton.styleFrom(
                                              ...
                                              elevation: 0),
                                          onPressed: () async {
                                            _hotDetailsController.AddToCart(
                                                "${_hotDetailsController.gethotDetails?.hotDeals?[index].id}");
                                          },
                                          child: Text(
                                            'Add',
                                            style: GoogleFonts.montserrat(
